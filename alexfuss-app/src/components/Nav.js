        ...
        return (
          ...
          <nav className="navbar navbar-expand-lg navbar-light">
            <a className="navbar-brand" href="https://alexfuss.github.io/">
              ...
              <img src="../../public/Images/alexfuss.github.io/assets/16996ff1-4730-4e2e-8147-4f3cbe28dbbe_200x200.png" width={50} height={50} alt="AF custom logo" loading="lazy" className="nav-img" />
            </a>
